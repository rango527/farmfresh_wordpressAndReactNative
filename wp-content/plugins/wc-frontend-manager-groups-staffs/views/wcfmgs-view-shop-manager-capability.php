	...
	<div class="vendor_other_capability">
		...
		<?php if( WCFM_Dependencies::wcfmd_plugin_active_check() ) { ?>
			<?php if( apply_filters( 'wcfm_is_pref_delivery', true ) ) { ?>
				...
				<?php
					$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_capability_settings_fields_shop_manager_delivery', array(  
																																			 "delivery" => array('label' => __('Delivery', 'wc-frontend-manager-delivery') , 'name' => 'wcfm_shop_manager_capability_options[delivery]', 'type' => 'checkboxoffon', 'class' => 'wcfm-checkbox wcfm_ele', 'value' => 'yes', 'label_class' => 'wcfm_title checkbox_title', 'dfvalue' => $delivery),
																												) ) );
				?>
			<?php } ?>
		<?php } ?>
