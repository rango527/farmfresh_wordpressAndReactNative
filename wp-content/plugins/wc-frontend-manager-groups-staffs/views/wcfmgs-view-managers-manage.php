	  ...
	  <div class="wcfm-container wcfm-top-element-container">
	    <h2><?php if( $manager_id ) { _e('Edit Manager', 'wc-frontend-manager-groups-staffs' ); } else { _e('Add Manager', 'wc-frontend-manager-groups-staffs' ); } ?></h2>
			...
			if( $allow_wp_admin_view = apply_filters( 'wcfm_allow_wp_admin_view', true ) ) {
				?>
				<a target="_blank" class="wcfm_wp_admin_view text_tip" href="<?php echo admin_url('user-new.php'); ?>" data-tip="<?php _e( 'WP Admin View', 'wc-frontend-manager-groups-staffs' ); ?>"><span class="wcfmfa fa-wordpress"></span></a>
				<?php
			}
