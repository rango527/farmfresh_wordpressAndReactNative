...
class WooCustomizeSettingsPage
{
    ...
    {
        printf('<div class="notice  is-dismissible notice-success"><p>%1$s</p><strong><a href="http://www.ceylonthemes.com" target="new">%2$s</a></strong>
		&nbsp;&nbsp;<strong><a href="https://wordpress.org/themes/author/ceylonthemes/" target="new">%3$s</a></strong>
		&nbsp;&nbsp;<strong><a href="http://www.ceylonthemes.com" target="new">%4$s</a><span><span/><br />&nbsp;</div>',
				...
				esc_html('Premium support - Go Pro','customizer-for-woocommerce'),
				esc_html('See our FREE WooCommerce Themes ','customizer-for-woocommerce'),
				esc_html('ALL THEMES FOR SINGLE PURCHASE (LIMITED TIME OFFER)','customizer-for-woocommerce')			
			  );
    }
