		...
		return array(
			array(
				...
				'desc'     => __( 'Will replace standard WooCommerce quantity number input with dropdown.', 'product-quantity-for-woocommerce' ) . ' ' .
					__( 'Please note that <strong>maximum quantity</strong> value must be set for the product (either via "Maximum Quantity" section or e.g. by setting maximum available product stock quantity or with "Max value fallback" option below), You can also show dropdown by defining fixed (allowed) quantites for products now.', 'product-quantity-for-woocommerce' ),
			),
			array(
