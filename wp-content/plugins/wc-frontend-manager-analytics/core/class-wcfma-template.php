...
/**
 * @class 		WCFMa Template Class
 *
 * @version		1.0.0
 * @package		WC
 * @author 		WC Lovers
 */
class WCFMa_Template {

    public $template_url;

    public function __construct() {
        $this->template_url = 'wcfm/analytics/';
    }
    ...
    public function get_template_part($slug, $name = '') {
        ...
        if (!$template && $name && file_exists($WCFMa->plugin_path . "views/{$slug}-{$name}.php"))
            $template = $WCFMa->plugin_path . "views/{$slug}-{$name}.php";
