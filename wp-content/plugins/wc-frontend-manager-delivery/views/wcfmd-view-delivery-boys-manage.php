						...
						<?php
						  if( $delivery_boy_id ) {
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_delivery_manager_fields_general', array(  
																																						...
																																						"wcfm_vendor" => array( 'label' => __( 'Vendor', 'wc-frontend-manager-delivery' ), 'type' => 'select', 'options' => $vendor_arr, 'class' => 'wcfm-select wcfm_ele ' .$wcfm_vendor_class, 'label_class' => 'wcfm_title ' . $wcfm_vendor_class, 'value' => $wcfm_vendor ),
