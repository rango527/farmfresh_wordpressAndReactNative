...
class WCFMph_API_Manager_Update_API_Check {
	...
	public function expired_license_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The license key for %s has expired. You can reactivate or purchase a license key from your account <a href="%s" target="_blank">dashboard</a>.', 'wc-frontend-manager-product-hub' ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function on_hold_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s is on-hold. You can reactivate the subscription from your account <a href="%s" target="_blank">dashboard</a>.', 'wc-frontend-manager-product-hub' ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function cancelled_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has been cancelled. You can renew the subscription from your account <a href="%s" target="_blank">dashboard</a>. A new license key will be emailed to you after your order has been completed.', 'wc-frontend-manager-product-hub' ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function expired_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has expired. You can reactivate the subscription from your account <a href="%s" target="_blank">dashboard</a>.', 'wc-frontend-manager-product-hub' ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function suspended_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has been suspended. You can reactivate the subscription from your account <a href="%s" target="_blank">dashboard</a>.', 'wc-frontend-manager-product-hub' ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function pending_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s is still pending. You can check on the status of the subscription from your account <a href="%s" target="_blank">dashboard</a>.', 'wc-frontend-manager-product-hub' ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function trash_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has been placed in the trash and will be deleted soon. You can purchase a new subscription from your account <a href="%s" target="_blank">dashboard</a>.', 'wc-frontend-manager-product-hub' ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function no_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'A subscription for %s could not be found. You can purchase a subscription from your account <a href="%s" target="_blank">dashboard</a>.', 'wc-frontend-manager-product-hub' ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function no_key_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'A license key for %s could not be found. Maybe you forgot to enter a license key when setting up %s, or the key was deactivated in your account. You can reactivate or purchase a license key from your account <a href="%s" target="_blank">dashboard</a>.', 'wc-frontend-manager-product-hub' ) . '</p></div>', $plugin_name, $plugin_name, $this->renew_license_url ) ;
	...
	public function download_revoked_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'Download permission for %s has been revoked possibly due to a license key or subscription expiring. You can reactivate or purchase a license key from your account <a href="%s" target="_blank">dashboard</a>.', 'wc-frontend-manager-product-hub' ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
	...
	public function no_activation_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( '%s has not been activated. Go to the settings page and enter the license key and license email to activate %s.', 'wc-frontend-manager-product-hub' ) . '</p></div>', $plugin_name, $plugin_name ) ;
	...
	public function switched_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'You changed the subscription for %s, so you will need to enter your new API License Key in the settings page. The License Key should have arrived in your email inbox, if not you can get it by logging into your account <a href="%s" target="_blank">dashboard</a>.', 'wc-frontend-manager-product-hub' ) . '</p></div>', $plugin_name, $this->renew_license_url ) ;
