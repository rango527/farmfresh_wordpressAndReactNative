...
/* Slider Settings */
		...
		$wp_customize->add_section( 'slider_nav_section' , array(
			'title'      => __('Product Slider, Navigation & Banner', 'storefront-business' ),			
			'description'=> __('Display a product slider and product categories in front page template. Slider, navigation widget and more options, Go Pro version.', 'storefront-business' ),
			'panel' => 'theme_options',
			'priority'   => 40
		) );
		...
		'label' => __('Show Home Product Slider and Navigation','storefront-business' ),
		...
		'label' => __('Product Categories to show in Navigation','storefront-business' ),
		'section' => 'slider_nav_section',
		'type'=>'number',
		) );				
		...
		'label' => __('Slider Effects','storefront-business' ),
		'section' => 'slider_nav_section',
		'type'=>'select',
		'choices'=>array(
			'slide'=> __('Slide', 'storefront-business' ),
			'fade'=> __('Fade', 'storefront-business' ),
		),
		) );
		...
		'label' => __('Slider animation speed(ms)','storefront-business' ),
		'section' => 'slider_nav_section',
		'type'=>'select',
		'choices'=>array(
			500 => 500,
        ...
        $wp_customize->add_setting( 'slider_nav_label1', array(
            'default'        => __('Select Posts with featured image','storefront-business' ),
			'sanitize_callback' => 'sanitize_text_field',
        ) );

        $wp_customize->add_control( new new_york_business_Label_Custom_control( $wp_customize, 'slider_nav_label1', array(
            'label'   => __('Select Products with featured image','storefront-business' ),
            'section' => 'slider_nav_section',
        ) ) );		
		...
		'label' => __('Select Product Category','storefront-business' ),
		'section' => 'slider_nav_section',
		'type'=>'select',
		...
		'label' => __('Slider Height (Max)','storefront-business' ),
		'section' => 'slider_nav_section',
		'type'=>'number',
		) );
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'slider_banner_image', array(
			'label'             => __('Select Banner', 'storefront-business'),
			'section'           => 'slider_nav_section',
