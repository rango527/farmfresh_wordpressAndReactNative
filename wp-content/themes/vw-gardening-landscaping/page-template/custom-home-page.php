          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption">
              <div class="inner_carousel">
                ...
                <div class="more-btn">
                  <a href="<?php echo esc_url(get_permalink()); ?>"><?php esc_html_e( 'READ MORE', 'vw-gardening-landscaping' ); ?><span class="screen-reader-text"><?php esc_html_e( 'READ MORE','vw-gardening-landscaping' );?></span></a>
                </div>
              </div>
            </div>
          </div>
